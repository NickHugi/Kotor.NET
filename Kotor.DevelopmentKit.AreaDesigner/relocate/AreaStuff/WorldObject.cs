...
public class WorldObject : UltimateWorldObject
{
    ...
    public WorldObject(Room parent, Magnet parentMagnet, UltimateWorldObjectTemplate template) : base(parent, parentMagnet, template, Guid.NewGuid(), WorldObjectType.Prop)
    {
        Parent = parent;
