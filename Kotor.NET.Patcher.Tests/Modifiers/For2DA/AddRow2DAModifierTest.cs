...
public class AddRow2DAModifierTest
{
    ...
    [Fact]
    public void Apply_NoMatchingRow()
    {
        var twoda = Generate2DA();

        var modifier = new AddRow2DAModifier
        {
            OverrideRowLocator = new RowLocatorByRowHeader { RowHeader = "doesnotexist" },
            Assignments =
            [
                new RowHeaderAssignment { Value = new ValueResolverForConstant { Value = "Row3" } },
                new RowCellAssignment { ColumnHeader = "Column0", Value = new ValueResolverForConstant { Value = "123" } },
            ]
        };
        ...
        using (var scope = new AssertionScope())
        {
            ...
            twoda.GetRow(3).GetCell("Column0").AsString().Should().Be("123");
            twoda.GetRow(3).GetCell("Column1").AsString().Should().Be("");
            twoda.GetRow(3).GetCell("Column2").AsString().Should().Be("");
        }
    }

    [Fact]
    public void Apply_MatchingRow()
    {
        var twoda = Generate2DA();

        var modifier = new AddRow2DAModifier
        {
            OverrideRowLocator = new RowLocatorByRowHeader { RowHeader = "Row1" },
            Assignments =
            [
                new RowCellAssignment { ColumnHeader = "Column0", Value = new ValueResolverForConstant { Value = "123" } },
                new RowCellAssignment { ColumnHeader = "Column1", Value = new ValueResolverForConstant { Value = "e" } },
            ]
        };
        ...
        using (var scope = new AssertionScope())
        {
            ...
            twoda.GetRow(1).RowHeader.Should().Be("Row1");
            twoda.GetRow(1).GetCell("Column0").AsString().Should().Be("123");
            twoda.GetRow(1).GetCell("Column1").AsString().Should().Be("e");
            twoda.GetRow(1).GetCell("Column2").AsString().Should().Be("f");
    ...
    [Fact]
    public void Apply_DontLookForRow()
    {
        var twoda = Generate2DA();
        ...
        var modifier = new AddRow2DAModifier
        {
            ...
            [
                new RowHeaderAssignment { Value = new ValueResolverForConstant { Value = "Row3" } },
                new RowCellAssignment { ColumnHeader = "Column1", Value = new ValueResolverForConstant { Value = "123" } },
            ]
        };
        ...
        using (var scope = new AssertionScope())
        {
            ...
            twoda.GetRow(3).RowHeader.Should().Be("Row3");
            twoda.GetRow(3).GetCell("Column0").AsString().Should().Be("");
            twoda.GetRow(3).GetCell("Column1").AsString().Should().Be("123");
            twoda.GetRow(3).GetCell("Column2").AsString().Should().Be("");
        }
    }
}
