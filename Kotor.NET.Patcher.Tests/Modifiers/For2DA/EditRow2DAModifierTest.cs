...
public class EditRow2DAModifierTest
{
    ...
    public void Apply()
    {
        ...
        var modifier = new EditRow2DAModifier
        {
            ...
            Assignments =
            [
                new RowCellAssignment { ColumnHeader = "Column0", Value = new ValueResolverForConstant { Value = "edited cell 1" } },
                new RowCellAssignment { ColumnHeader = "Column2", Value = new ValueResolverForPatcherMemory { Key = "2DAMEMORY0" } },
            ]
        };

        var memory = new PatcherMemory();
        memory.Set("2DAMEMORY0", "edited cell 2");
        ...
        using (var scope = new AssertionScope())
        {
            ...
            twoda.GetRow(1).GetCell("Column0").AsString().Should().Be("edited cell 1");
            twoda.GetRow(1).GetCell("Column1").AsString().Should().Be("e");
            twoda.GetRow(1).GetCell("Column2").AsString().Should().Be("edited cell 2");
