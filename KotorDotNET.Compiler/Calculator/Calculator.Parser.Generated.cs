...
// Input file <Calculator\Calculator.Language.grammar.y - 28/09/2023 10:52:06 PM>
...
#pragma warning restore 649
  private static Rule[] rules = new Rule[134];
  ...
  static CalculatorParser() {
    ...
    states[54] = new State(new int[]{46,55,40,57,168,-131,169,-131,191,-131,170,-131,61,-131,166,-131,167,-131,59,-81,180,-81,179,-81,182,-81,181,-81,183,-81,178,-81,177,-81,184,-81,173,-81,174,-81,175,-81,176,-81,187,-81,188,-81,186,-81,171,-81,172,-81,190,-81,41,-81,44,-81,58,-81});
    ...
    states[64] = new State(-110);
    states[65] = new State(-111);
    states[66] = new State(-112);
    states[67] = new State(-113);
    states[68] = new State(-114);
    states[69] = new State(-115);
    states[70] = new State(-116);
    states[71] = new State(-117);
    ...
    states[82] = new State(new int[]{46,55,59,-131,180,-131,179,-131,182,-131,181,-131,183,-131,178,-131,177,-131,184,-131,173,-131,174,-131,175,-131,176,-131,187,-131,188,-131,186,-131,171,-131,172,-131,190,-131,41,-131,44,-131,58,-131});
    ...
    states[233] = new State(new int[]{149,121,150,122,151,123,152,124,153,125,154,126,155,127,156,128,157,129,158,130,160,131,159,132,148,133,161,-130},new int[]{-18,234,-11,235});
    ...
    rules[110] = new Rule(-43, new int[]{165});
    rules[111] = new Rule(-43, new int[]{164});
    rules[112] = new Rule(-43, new int[]{163});
    rules[113] = new Rule(-43, new int[]{162});
    rules[114] = new Rule(-43, new int[]{134});
    rules[115] = new Rule(-43, new int[]{135});
    rules[116] = new Rule(-43, new int[]{136});
    rules[117] = new Rule(-43, new int[]{137});
    rules[118] = new Rule(-11, new int[]{149});
    rules[119] = new Rule(-11, new int[]{150});
    rules[120] = new Rule(-11, new int[]{151});
    rules[121] = new Rule(-11, new int[]{152});
    rules[122] = new Rule(-11, new int[]{153});
    rules[123] = new Rule(-11, new int[]{154});
    rules[124] = new Rule(-11, new int[]{155});
    rules[125] = new Rule(-11, new int[]{156});
    rules[126] = new Rule(-11, new int[]{157});
    rules[127] = new Rule(-11, new int[]{158});
    rules[128] = new Rule(-11, new int[]{160});
    rules[129] = new Rule(-11, new int[]{159});
    rules[130] = new Rule(-11, new int[]{148,161});
    rules[131] = new Rule(-42, new int[]{161});
    rules[132] = new Rule(-42, new int[]{161,46,161});
    rules[133] = new Rule(-42, new int[]{-42,46,161});
  }
...
{ ; }
        break;
      case 110: // constant_expression -> LITERAL_INT
{ CurrentSemanticValue.node = new IntLiteralExpression(ValueStack[ValueStack.Depth-1].numberi); }
        break;
      case 118: // data_type -> TYPE_INT
{ ; }
        break;
      case 119: // data_type -> TYPE_FLOAT
{ ; }
        break;
      case 120: // data_type -> TYPE_OBJECT
{ ; }
        break;
      case 121: // data_type -> TYPE_VOID
{ ; }
        break;
      case 122: // data_type -> TYPE_EVENT
{ ; }
        break;
      case 123: // data_type -> TYPE_EFFECT
{ ; }
        break;
      case 124: // data_type -> TYPE_ITEM_PROPERTY
{ ; }
        break;
      case 125: // data_type -> TYPE_LOCATION
{ ; }
        break;
      case 126: // data_type -> TYPE_STRING
{ ; }
        break;
      case 127: // data_type -> TYPE_TALENT
{ ; }
        break;
      case 128: // data_type -> TYPE_VECTOR
{ ; }
        break;
      case 129: // data_type -> TYPE_ACTION
{ ; }
        break;
      case 130: // data_type -> TYPE_STRUCT, IDENTIFIER
{ ; }
        break;
    }
