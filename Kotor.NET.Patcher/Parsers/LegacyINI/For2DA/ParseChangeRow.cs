...
public class ParseChangeRow
{
    public EditRow2DAModifier Parse(KeyDataCollection section)
    {
        return new()
        {
            ...
            RowHeader = ParseRowHeader(section),
    ...
    private ICellValue? ParseRowHeader(KeyDataCollection section)
    {
        return null;
    }
    ...
    private List<IAssignment> ParseAssignments(KeyDataCollection section)
    {
        return section
            ...
            .Select<KeyData, IAssignment>(entry =>
            {
                ...
                {
                    return new MemoryTLKAssignment() { Key = entry.KeyName, Value = value };
                }
                else
                {
