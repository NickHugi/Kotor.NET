...
{
    public class BitwiseShiftRightExpression : IExpression
    {
        public IExpression LHS { get; set; }
        public IExpression RHS { get; set; }

        public BitwiseShiftRightExpression(IExpression lhs, IExpression rhs)
        {
            LHS = lhs;
            RHS = rhs;
        }
        ...
        public void Compile(SymbolTable symbolTable, NCS ncs)
        {
            ...
            {
                ncs.Add(new NCSInstruction.SHRIGHTII());
            }
            else
            {
