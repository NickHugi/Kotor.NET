...
{
    public IFieldGFFTreeNodeViewModel Node { get; }

    public DeleteFieldAction(IFieldGFFTreeNodeViewModel node)
    {
        Node = node;
    }
    ...
    {
        if (Node.Parent is BaseStructGFFTreeNodeViewModel vmStruct)
        {
