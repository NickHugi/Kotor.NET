    ...
    public static class PathHelper
    {
        ...
        public static FileSystemInfo GetCaseSensitivePath(FileSystemInfo fileSystemInfoItem)
        {
            switch ( fileSystemInfoItem )
            {
                ...
                default: throw new ArgumentException("Unsupported file system info type", nameof(fileSystemInfoItem));
            }
        }
        ...
        // Finds all duplicates of a path
        public static IEnumerable<FileSystemInfo> FindCaseInsensitiveDuplicates( string path, bool includeSubFolders = true, bool? isFile = null )
        {
            ...
            // validate the arg's case-insensitive existence here.
